<template>
  <div class="relative flex flex-col items-center">
    ...
    <div
      :class="[
        'relative z-10 w-12 h-12 rounded-full flex items-center justify-center font-bold text-lg transition-all duration-200',
        completed
  ...
  v-if="index < 3"
  :class="[
    'absolute hidden md:block h-1 top-6 left-[calc(50%+34px)]',
    completed
      ? 'bg-white'
